public class Pirate {
	...
	/*
	 *  A pirate could lose a limb during combat.
	 *  If so, we deduct a limb.  If the pirate
	 *  already lost all his/her limbs then the 
	 *  pirate dies and cannot lose anymore limbs.
	 */
